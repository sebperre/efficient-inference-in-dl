...
def setup():
    full_train = ImageFolder(root="../imagewoof/train", transform=transform)
    ...
    test_dataset = ImageFolder(root="../imagewoof/val", transform=transform)
...
if __name__ == "__main__":
    ...
    f, PATH = write_file("iterative_models", "ImageWoof", "Mini-VGGs", num_epochs, None, acc_sac)
